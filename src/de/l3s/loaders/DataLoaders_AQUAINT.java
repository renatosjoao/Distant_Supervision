...
public class DataLoaders_AQUAINT extends DataLoaders{
	

	public static void main(String[] args) throws NumberFormatException, IOException {
		
//		docsContent = new TreeMap<String, String>();
//		dumpNumRecognizedMentionsFromAQUAINT();
//		dumpTextContent();
//		dumpWordCountFromAQUAINT();
//		dumpDocumentFrequencyFromAQUAINT();  /// ATTENTION here
		
		try {
			DataLoaders_AQUAINT d = DataLoaders_AQUAINT.getInstance();
...
//			 d.dumpTextContent();
	 ...
	 */
	public static DataLoaders_AQUAINT getInstance() throws CompressorException, IOException {
		if(instance == null) {
			 synchronized(DataLoaders_AQUAINT.class) {
				 instance = new DataLoaders_AQUAINT();
			 }
	    }
		return (DataLoaders_AQUAINT) instance;
	}
	
	
	public DataLoaders_AQUAINT() throws CompressorException, IOException{
	...
	***************************************************************************************************/
	...
	private static TreeMap<String, String> loadDocsContent() throws NumberFormatException, IOException {
		File directory = new File("/home/joao/datasets/aquaint/RawTexts/"); 
	...
	private static void loadDocFrequencyMap() throws CompressorException, IOException{
		BufferedReader bffReader = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/aquaint/document_frequency.tsv"),StandardCharsets.UTF_8));
		String line ="";											
	...
	private static void loadWordCount() throws CompressorException, IOException {
		BufferedReader bffReader = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/aquaint/doc_word_count.tsv"),StandardCharsets.UTF_8));
		String line ="";
		while((line = bffReader.readLine()) != null) {
			String[] elems = line.split("\t");
	...
	private static void loadNumMentionsRecognized() throws CompressorException, IOException {
		BufferedReader bffReader = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/aquaint/num_recognized_mentions.tsv"),StandardCharsets.UTF_8));
		String line ="";
		while((line = bffReader.readLine()) != null) {
			String[] elems = line.split("\t");
			String docId = elems[0].toLowerCase();
	...
	private void loadGT() throws IOException {
		BufferedReader bffReader = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/aquaint/AQUAINT_GT.tsv"),StandardCharsets.UTF_8));
		String line = "";
		while((line = bffReader.readLine() )!= null) {
			String[] elems = line.split("\t");
			String docId = elems[0].toLowerCase();
...
//		    mention = mention.replaceAll("\"", "");
	...
	private static void loadMappings() throws IOException{
		...
		BufferedReader bffReaderAmbiverse = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/aquaint/mappings/aquaint.ambiverse.mappings"),StandardCharsets.UTF_8));
		BufferedReader bffReaderBabelfy = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/aquaint/mappings/aquaint.babelfy.mappings"),StandardCharsets.UTF_8));
		BufferedReader bffReaderTagme =   new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/aquaint/mappings/aquaint.tagme.mappings"),StandardCharsets.UTF_8));
//		BufferedReader bffReaderSpotLight =   new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/aquaint/mappings/AQUAINT_spotlight_all.mappings"),StandardCharsets.UTF_8));
...
//		bffReaderSpotLight.close();
		...
		/////// TEST 
//		bffReaderAmbiverse = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/aquaint/mappings/AQUAINT_ambiverse_test.mappings"),StandardCharsets.UTF_8));
//		bffReaderBabelfy = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/aquaint/mappings/AQUAINT_bfy_test.mappings"),StandardCharsets.UTF_8));
//		bffReaderTagme =   new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/aquaint/mappings/AQUAINT_tagme_test.mappings"),StandardCharsets.UTF_8));
////		bffReaderSpotLight =   new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/aquaint/mappings/AQUAINT_spotlight_test.mappings"),StandardCharsets.UTF_8));
//		
//		line="";
//		while ((line = bffReaderAmbiverse.readLine()) != null) {
//			String[] elems = line.split("\t");
...
//		bffReaderSpotLight.close();
	 ...
	 * 						/home/joao/datasets/aquaint/doc_word_count.tsv
	 * @throws NumberFormatException
	 * @throws IOException
	 */

	private static void dumpWordCountFromAQUAINT() throws IOException {
		OutputStreamWriter pAnn = new OutputStreamWriter(new FileOutputStream("/home/joao/datasets/aquaint/doc_word_count.tsv"),StandardCharsets.UTF_8);
		File directory = new File("/home/joao/datasets/aquaint/RawTexts/"); 
   		String[] extensions = {"htm"};
       	List<File> listOfFiles =  (List<File>) FileUtils.listFiles(directory, extensions,true);
       	for(File f : listOfFiles){
	 ...
	 * @throws IOException
	 */
	public static void dumpDocumentFrequencyFromAQUAINT() throws IOException{
		HashSet<String> mentionsSET = new HashSet<String>();
		OutputStreamWriter pAnn = new OutputStreamWriter(new FileOutputStream("/home/joao/datasets/aquaint/document_frequency.tsv"),StandardCharsets.UTF_8);
		TreeMap<String, String>  docsContentMap = loadDocsContent();
		BufferedReader bff = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/aquaint/AQUAINT_GT.tsv"),StandardCharsets.UTF_8));
		String line="";
	 ...
	 * @throws CompressorException
	 */
	public static void dumpNumRecognizedMentionsFromAQUAINT() throws NumberFormatException, IOException{
		OutputStreamWriter pAnn = new OutputStreamWriter(new FileOutputStream("/home/joao/datasets/aquaint/num_recognized_mentions.tsv"),StandardCharsets.UTF_8);
		BufferedReader bff = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/aquaint/AQUAINT_GT.tsv"),StandardCharsets.UTF_8));
	...
	private static void dumpTextContent() throws NumberFormatException, IOException {
		OutputStreamWriter out = new OutputStreamWriter(new FileOutputStream("/home/joao/datasets/aquaint/corpus.tsv"), StandardCharsets.UTF_8);
		File directory = new File("/home/joao/datasets/aquaint/RawTexts/"); 
  		String[] extensions = {"htm"};
      	List<File> listOfFiles =  (List<File>) FileUtils.listFiles(directory, extensions,true);
	...
	public static void setBabelMap_test(TreeMap<String, String> babelMap_test) {
		DataLoaders_AQUAINT.babelMap_test = babelMap_test;
	}

	public static void setTagmeMap_test(TreeMap<String, String> tagmeMap_test) {
		DataLoaders_AQUAINT.tagmeMap_test = tagmeMap_test;
	}
