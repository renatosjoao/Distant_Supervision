...
public class DataLoaders_N3RSS500  extends DataLoaders {
...
//		dumpGT();
//		dumpTextContent();
//		dumpNumRecognizedMentionsFromN3RSS500();
//		dumpWordCountFromN3RSS500();
//		dumpDocumentFrequencyFromN3RSS500();
		DataLoaders_N3RSS500 d = new DataLoaders_N3RSS500();
		System.out.println(d.hashCode());

	}
	

	public static DataLoaders_N3RSS500 getInstance() throws CompressorException, IOException {
		if(instance == null) {
			 synchronized(DataLoaders_N3RSS500.class) {
				 instance = new DataLoaders_N3RSS500();
			 }
	    }
		return  (DataLoaders_N3RSS500) instance;
	}
	
	
	public DataLoaders_N3RSS500() throws CompressorException, IOException {
...
// 		loadMentionEntityCountMap();
	...
	***************************************************************************************************/
	 ...
	 * 
	 **/
	private static void loadDocsContent() throws NumberFormatException, IOException {
		String nifPath = "/home/joao/datasets/N3RSS500/RSS-500.ttl";
...
//			docName = "\'"+docName+  "\'.txt";
	...
	public static void loadDocFrequencyMap() throws CompressorException, IOException{
		BufferedReader bffReader = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/N3RSS500/document_frequency.tsv"),StandardCharsets.UTF_8));
		String line ="";											
		while((line = bffReader.readLine()) != null) {
	...
	public static void loadWordCount() throws CompressorException, IOException {
		BufferedReader bffReader = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/N3RSS500/doc_word_count.tsv"),StandardCharsets.UTF_8));
		String line ="";
		while((line = bffReader.readLine()) != null) {
			String[] elems = line.split("\t");
	...
	public static void loadNumMentionsRecognized() throws CompressorException, IOException {
		BufferedReader bffReader = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/N3RSS500/num_recognized_mentions.tsv"),StandardCharsets.UTF_8));
		String line ="";
		while((line = bffReader.readLine()) != null) {
			String[] elems = line.split("\t");
			String docId = elems[0].toLowerCase();
	...
	public static void loadGT() throws IOException{
		BufferedReader bffReader = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/N3RSS500/N3RSS500_GT.tsv"),StandardCharsets.UTF_8));
	...
	private static void loadMappings() throws IOException{
		BufferedReader bffReaderAmbiverse = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/N3RSS500/mappings/N3RSS500.ambiverse.mappings"),StandardCharsets.UTF_8));
		BufferedReader bffReaderBabelfy = new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/N3RSS500/mappings/N3RSS500.babelfy.mappings"),StandardCharsets.UTF_8));
		BufferedReader bffReaderTagme =   new BufferedReader(new InputStreamReader(new FileInputStream("/home/joao/datasets/N3RSS500/mappings/N3RSS500.tagme.mappings"),StandardCharsets.UTF_8));
...
//			    mention = mention.replaceAll("\"", "");
	 ...
	 * 						/home/joao/datasets/N3RSS500/doc_word_count.tsv
	 * 
	 * @throws NumberFormatException
	 * @throws IOException
	 */
	private static void dumpWordCountFromN3RSS500() throws IOException {
		OutputStreamWriter pAnn = new OutputStreamWriter(new FileOutputStream("/home/joao/datasets/N3RSS500/doc_word_count.tsv"), StandardCharsets.UTF_8);
...
//			docName = "\'"+docName+  "\'.txt";
	 ...
	 * @throws IOException
	 */
	private static void dumpDocumentFrequencyFromN3RSS500() throws IOException {
		HashSet<String> mentionsSET = new HashSet<String>();
		OutputStreamWriter pAnn = new OutputStreamWriter(new FileOutputStream("/home/joao/datasets/N3RSS500/document_frequency.tsv"), StandardCharsets.UTF_8);
...
//			docName = "\'"+docName+  "\'.txt";
		...
		BufferedReader bff = new BufferedReader(new InputStreamReader(	new FileInputStream("/home/joao/datasets/N3RSS500/N3RSS500_GT.tsv"), StandardCharsets.UTF_8));
		line = "";
	...
	/**
	 *	This utility function is meant to fetch the number of recognized mentions per document in the N3RSS500 corpus.
	 *	
	 *	It produces the file:
	 *
	 *			/home/joao/datasets/N3RSS500/num_recognized_mentions.tsv
	 *
	 * @throws NumberFormatException 
	 * @throws IOException
	 * @throws CompressorException
	 */
	private static void dumpNumRecognizedMentionsFromN3RSS500() throws IOException {
		OutputStreamWriter pAnn = new OutputStreamWriter(new FileOutputStream("/home/joao/datasets/N3RSS500/num_recognized_mentions.tsv"),StandardCharsets.UTF_8);
		BufferedReader bff = new BufferedReader(new InputStreamReader(	new FileInputStream("/home/joao/datasets/N3RSS500/N3RSS500_GT.tsv"), StandardCharsets.UTF_8));
...
//			docName = "\'"+docName+  "\'.txt";
			String docContent = d.getText();
			OutputStreamWriter out = new OutputStreamWriter(new FileOutputStream("/home/joao/datasets/N3RSS500/TEXT_FILES/"+docName), StandardCharsets.UTF_8);
	...
	public static void dumpGT() throws IOException {
		OutputStreamWriter out = new OutputStreamWriter(new FileOutputStream("/home/joao/datasets/N3RSS500/N3RSS500_GT.tsv"), StandardCharsets.UTF_8);
		String nifPath = "/home/joao/datasets/N3RSS500/RSS-500.ttl";
...
//			line = line.replaceAll("%22","\"").replaceAll("%26","&").replaceAll("%27","\'").replaceAll("%C3","Ã");
...
//			line  = new String(data);
	...
	public static void setAmbiverseMap_test(TreeMap<String, String> ambiverseMap_test) {
		DataLoaders_N3RSS500.ambiverseMap_test = ambiverseMap_test;
	}
	...
	public static void setBabelMap_test(TreeMap<String, String> babelMap_test) {
		DataLoaders_N3RSS500.babelMap_test = babelMap_test;
	}
	...
	public static void setTagmeMap_test(TreeMap<String, String> tagmeMap_test) {
		DataLoaders_N3RSS500.tagmeMap_test = tagmeMap_test;
	}
	...
	public static void setSpotlightMap(TreeMap<String, String> spotlightMap) {
		DataLoaders_N3RSS500.spotlightMap = spotlightMap;
	}
	public static void setSpotlightMap_train(TreeMap<String, String> spotlightMap_train) {
		DataLoaders_N3RSS500.spotlightMap_train = spotlightMap_train;
	}
	public static void setSpotlightMap_test(TreeMap<String, String> spotlightMap_test) {
		DataLoaders_N3RSS500.spotlightMap_test = spotlightMap_test;
	}
}
